...
![Tracking with trajectory calculated, mask of bloba, blob's geometry as computed through topological persistence, and the MPE interface showing voices assigned to blobs and synth control to edit active voices.](media/mask_trajectory_topology_mpe.png)
